...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin/index', ['datas' => $data, 'jumlah_data' => $jumlah_data, 'channel' => $channel, 'total_channel' => $total_channel, 'total_santri' => $jumlah_santri]);
    }
    ...
    public function update(Request $request)
    {
		...
		if ($validator->fails()) {
			...
			try{
                ...
                Admin::where('id_pesantren', $id_pesantren)->update([
                    'nama_pesantren' => $nama_pesantren,
                    'alamat_pesantren' => $alamat_pesantren,
                ]);
    ...
    {   
        ...
        $data = Admin::where('id_pesantren', '=', $id_pesantren)->delete();
